...
namespace WindowsFormsApp1
{
    ...
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (miAlumno.Nota<5) { miAlumnoNotaTexto = "Suspenso"; }
            else if (miAlumno.Nota<7) { miAlumnoNotaTexto = "Aprobado"; }
            else if (miAlumno.Nota<9) { miAlumnoNotaTexto = "Notable"; }
            else { miAlumnoNotaTexto = "Sobresaliente"; }
